...
// echo '<br>line 55';		
			...
			{	
// echo '<br>line 58';			
				$stmt = $conn->prepare('select max(time), time, lat, lng from trackme where tel = :tel');
...
{
	$qry = "insert into trackme (time, tel, lat, lng) values ( '" . $_GET['time'] . "', 
		'" . $_GET['tel'] . "', '" . $_GET['lat'] . "', '" . $_GET['lng'] . "')";
